...
COMPOSE_MONITORING_BASE := -f docker-compose.yml -f docker-compose.monitor-base.yml
...
monitoring-base:## Start ELK Monitoring base (Prometheus + Grafana)
	$(DOCKER_COMPOSE_COMMAND) ${COMPOSE_MONITORING_BASE} up -d --build ${ELK_MONITORING_BASE}

monitoring:		## Start ELK Monitoring.
	$(DOCKER_COMPOSE_COMMAND) ${COMPOSE_MONITORING} up -d --build ${ELK_MONITORING}

down-monitoring:		## Start ELK Monitoring.
	$(DOCKER_COMPOSE_COMMAND) ${COMPOSE_MONITORING} stop ${ELK_MONITORING}
